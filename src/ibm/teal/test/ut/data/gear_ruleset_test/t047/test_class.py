...
class Class047(ExtEvaluate, ExtExecute):
    '''
    classdocs
    '''
    ...
    def evaluate(self, dict_in):
        ''' '''
#        print 'Values for Class047 Evaluate >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class047 Evaluate >> END'
        try:
            if dict_in['Elvis'] != 'is in the building':
                print 'fail 1'
                return False
            if dict_in['name'] != 'AnalyzerTest047':
                print 'fail 2'
                return False
            if dict_in['mode'] != 1:
                print 'fail 3'
            ...
            if dict_in['neighbor'] is not None and event.raw_data['neighbor'] != dict_in['neighbor']:
                print 'fail 7'
                return False
            if dict_in['version_id'] is not None:
                print 'fail 8'
                return False
        except:
...
#        print 'Values for Class047 Execute >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class047 Execute >> END'
        out_dict = {}
