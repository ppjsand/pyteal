...
class Class056(ExtEvaluate, ExtExecute):
    '''
    classdocs
    '''
    ...
    def evaluate(self, dict_in):
        ''' '''
        raise ValueError
#        print 'Values for Class056 Evaluate >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class056 Evaluate >> END'
#        try:
#            if dict_in['Elvis'] != 'is in the building':
#                print 'fail 1'
#                return False
#            if dict_in['name'] != 'AnalyzerTest056':
#                print 'fail 2'
#                return False
#            if dict_in['mode'] != 1:
#                print 'fail 3'
...
#        print 'Values for Class056 Execute >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class056 Execute >> END'
        out_dict = {}
