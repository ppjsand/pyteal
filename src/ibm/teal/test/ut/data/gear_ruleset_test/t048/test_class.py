...
class Class048(ExtEvaluate, ExtExecute):
    '''
    classdocs
    '''
    ...
    def evaluate(self, dict_in):
        ''' '''
#        print 'Values for Class048 Evaluate >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class048 Evaluate >> END'
        try:
            if dict_in['Elvis'] != 'is in the building':
                print 'fail 1'
                return False
            if dict_in['name'] != 'AnalyzerTest048':
                print 'fail 2'
                return False
            if dict_in['mode'] != 1:
                print 'fail 3'
            ...
            if dict_in['from_conf'] != "evaluate this!":
                print 'fail 8'
                return False
            if dict_in['version_id'] != "20100729a":
                print 'fail 9'
                return False
        except:
...
#        print 'Values for Class048 Execute >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class048 Execute >> END'
        out_dict = {}
