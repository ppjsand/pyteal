...
class Class046(ExtEvaluate, ExtExecute):
    '''
    classdocs
    '''
    ...
    def evaluate(self, dict_in):
        ''' '''
#        print 'Values for Class046 Evaluate >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class046 Evaluate >> END'
        try:
            if dict_in['Elvis'] != 'is in the building':
                print 'fail 1'
                return False
            if dict_in['name'] != 'AnalyzerTest046':
                print 'fail 2' + str(dict_in['name'])
                return False
            if dict_in['mode'] != 1:
                print 'fail 3'
                return False
...
#        print 'Values for Class046 Execute >> START'
#        for key in dict_in:
#            print str(key) + ' = ' + str(dict_in[key])
#        print 'Values for Class046 Execute >> END'
        return {'a':1, 'b':2}