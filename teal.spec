...
Source: pyteal-%{teal_ver}.tar.gz
BuildRequires: unixODBC-devel, python-devel
Distribution: pyteal
...
Requires: python >= 2.6, pyodbc >= 2.1.7

%description base-bg
The base framework for TEAL for BlueGene/Q
...
%config(noreplace) %attr( 644, bin, bin ) /opt/teal/data/ibm/ll/xml/LL_GEAR_rules.xml
%config(noreplace) %attr( 644, bin, bin ) /opt/teal/data/ibm/ll/xml/LL_GEAR_event_metadata.xml
...
%config(noreplace) %attr( 644, bin, bin ) /etc/teal/ll.conf

%endif
%if %{with_pnsd}
%package pnsd
Summary: Toolkit for Event Analysis and Logging PNSD Connector  	
...
%config(noreplace) %attr( 644, bin, bin ) /opt/teal/data/ibm/pnsd/xml/PNSD_GEAR_rules.xml
%config(noreplace) %attr( 644, bin, bin ) /opt/teal/data/ibm/pnsd/xml/PNSD_GEAR_event_metadata.xml
...
%config(noreplace) %attr( 644, bin, bin ) /etc/teal/sfp.conf
...
%attr( 755, bin, bin ) /opt/teal/ibm/teal/test/ut/aaaa_assumptions_test.py
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/aaaa_assumptions_test/minimal.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/alert_analyzer_test/test02.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/alert_filter_test/negative_alerts.json
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/alert_filter_test/test_12.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/inactive_test_1.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/inactive_test_2.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/inactive_test_3.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/inactive_test_4.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/int_db.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/int_db_01.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/new_analyzer.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/GEAR_move.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/GEAR_move_rule.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/immediate_test01.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/immediate_test01_synch.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/shutdown_immediate.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/events_01.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/GEAR_normal3a.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/GEAR_normal3b.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/GEAR_normal3c.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/normal1.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/normal2.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/normal3.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/stepping1.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/checkpoint_test/update/stepping2.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/configuration_test/configurationtest_03.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/configuration_test/configurationtest_04.conf
...
%attr( 755, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/__init__.py
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178935/alert_output2.json
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/alert_output1.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/alert_output2.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/alert_output3.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/alert_output4.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/config.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/CNM_GEAR_alert_metadata.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d179277/CNM_GEAR_rule.xml
...
%attr( 755, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/__init__.py
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output1.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output2.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output3.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output4.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output5.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output6.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output7.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output8.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output9.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output10.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/alert_output11.json
%attr( 755, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/cnm_gear.py
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/CNM_GEAR_alert_metadata.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/CNM_GEAR_rule.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d178106/config.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/config.conf
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/CNM_GEAR_alert_metadata.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/CNM_GEAR_event_metadata.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/CNM_GEAR_rule.xml
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/alert_output1a.json
%attr( 755, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/__init__.py
%attr( 755, bin, bin ) /opt/teal/ibm/teal/test/ut/data/gear_ruleset_test/bugs/d181301/cnm_gear.py
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/restart_test/three_events_one_fromq.json
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/teal_test/bad_03.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/teal_test/env_test.conf
...
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/alerts_002.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/alerts_003.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/alerts_fix_dup_001.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/alerts_many_dups_001.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/events_001.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/events_many_dups_001.json
%attr( 644, bin, bin ) /opt/teal/ibm/teal/test/ut/data/tlcommands_test/events_metadata_001.json
...
%attr( 644, bin, bin ) /opt/teal/data/ibm/gpfs/sql/update/Teal_gpfs_1104_db2.sql
%attr( 644, bin, bin ) /opt/teal/data/ibm/gpfs/xml/GPFS_GEAR_event_metadata.xml
%attr( 644, bin, bin ) /opt/teal/data/ibm/gpfs/xml/GPFS_GEAR_rules.xml
%attr( 644, bin, bin ) /opt/teal/data/ibm/gpfs/xml/GPFS_GEAR_alert_metadata.xml
%attr( 644, bin, bin ) /opt/teal/data/ibm/teal/xml/GPFS_1.xml
%attr( 755, bin, bin ) /opt/xcat/lib/perl/xCAT_schema/Teal_gpfs.pm
%attr( 755, bin, bin ) /install/postscripts/rmcmon/resources/node/IBM.EventResponse/GPFSConnectorFailed.pm
%attr( 755, bin, bin ) /install/postscripts/rmcmon/resources/node/IBM.Condition/GPFSConnectorMonitor.pm
%attr( 755, bin, bin ) /install/postscripts/rmcmon/resources/sn/IBM.EventResponse/GPFSConnectorFailed.pm
%attr( 755, bin, bin ) /install/postscripts/rmcmon/resources/sn/IBM.Condition/GPFSConnectorMonitor.pm
%config(noreplace) %attr( 644, bin, bin ) /etc/teal/gpfs.conf
...
Requires: gpfs.base >= 3.5.0-0, rsct.core >= 3.1.1, rsct.core.utils >= 3.1.1
